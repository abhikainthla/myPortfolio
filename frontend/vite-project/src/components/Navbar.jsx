...
const Navbar = () => {
  ...
  return (
    <Flex alignItems={'center'} justifyContent={'center'} gap='20' p={5} pos={'fixed'} zIndex={10} width={'100vw'} h={'auto'} boxShadow={'rgba(33, 35, 38, 0.1) 0px 10px 10px -10px'}  bg={colorMode === 'light' ? 'gray.100' : 'blue.800'}>
        <Flex>
